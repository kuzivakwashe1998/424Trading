// Inline SVG icon set — keeps the site self-contained (no icon CDN).
interface IconProps {
  className?: string;
}
...
export const GemIcon = ({ className = base }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 3h12l4 6-10 13L2 9l4-6zM2 9h20M12 22 8 9l4-6 4 6-4 13" />
  </svg>
);

export const DropletIcon = ({ className = base }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
